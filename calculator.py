...
class Calculator(QWidget):
    ...
    def stack1UI(self):
        """UI for Scotland""" 
        layout = QVBoxLayout()
        instruction = QLabel("Adjust percentages for each travel method from bus/rail station to university.")
    ...
    def stack4UI(self):
        layout = QHBoxLayout()
        layout.addWidget(QLabel("Mode of Transport"))
        layout.addWidget(QCheckBox("Car"))
        layout.addWidget(QCheckBox("Taxi"))
        layout.addWidget(QCheckBox("Bus"))
        layout.addWidget(QCheckBox("Walk"))
