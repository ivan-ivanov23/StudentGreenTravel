...
# Get the directory containing the Python interpreter executable
python_exe_dir = os.path.dirname(sys.executable)

# Construct the path to python310.dll
python310_dll_path = os.path.join(python_exe_dir, "python310.dll")

print(python310_dll_path)
